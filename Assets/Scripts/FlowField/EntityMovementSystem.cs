...
public class EntityMovementSystem : SystemBase
{
    ...
    // {
    //     _flowFieldQuery = GetEntityQuery(typeof(FlowFieldSettingData));
    //     _flowFieldEntity = _flowFieldQuery.GetSingletonEntity();
    //     _flowFieldData = EntityManager.GetComponentData<FlowFieldSettingData>(_flowFieldEntity);
    ...
    protected override void OnUpdate()
    {
        ...
        //     FlowFieldSettingData flowFieldData = _flowFieldData;
        //     int2 destinationCell = _flowFieldData.destinationIndex;
