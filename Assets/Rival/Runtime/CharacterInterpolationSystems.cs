...
namespace Rival
{
    ...
    public class CharacterInterpolationFixedUpdateSystem : SystemBase
    {
    ...
    public class CharacterInterpolationVariableUpdateSystem : SystemBase
    {
        private EntityQuery _interpolatedEntitiesQuery;
        ...
        public struct CharacterInterpolationUpdateJob : IJobChunk
        {
            ...
            public void Execute(ArchetypeChunk chunk, int chunkIndex, int firstEntityIndex)
            {
                ...
                for (int i = 0; i < chunk.Count; i++)
                {
                    ...
                    quaternion interpolatedRot = math.slerp(characterInterpolation.PreviousTransform.rot, targetTransform.rot, NormalizedTimeAhead);
                    float3 interpolatedPos = math.lerp(characterInterpolation.PreviousTransform.pos, targetTransform.pos, NormalizedTimeAhead);
