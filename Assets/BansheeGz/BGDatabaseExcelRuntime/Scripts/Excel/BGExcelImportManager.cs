...
namespace BansheeGz.BGDatabase
{
    public class BGExcelImportManager
    {
        ...
        private BGMergeSettingsEntity NewEntitySettings
        {
            get { return new BGMergeSettingsEntity {Mode = BGMergeModeEnum.Merge, UpdateMatching = true}; }
        }
        ...
        public BGLogger Import(string path, BGMergeSettingsEntity settings = null, BGSyncNameMapConfig NameMapConfig = null, BGSyncIdConfig idConfig = null)
        {
            ...
            ReadFile(Logger, path,
                content => reader = new BGExcelReaderRT(Logger, content, IsUsingXml(path), NameMapConfig, idConfig == null ? null : new BGExcelIdResolverFactoryRT(BGRepo.I, idConfig)));
